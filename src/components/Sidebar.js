...
const Sidebar = () => {
  ...
  return (
    <div className="flex flex-col h-screen p-3 w-60 bg-gray-900 text-gray-100">
	<div className="space-y-3">
		...
		<div className="flex-1">
			<ul className="pt-2 pb-4 space-y-1 text-sm">
				...
				<li className="rounded-sm">
					<Link rel="noopener noreferrer" to="/authentication" className="flex items-center p-2 space-x-3 rounded-md">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-400">
				...
				<li className="rounded-sm">
					<Link rel="noopener noreferrer" to="/analytics" className="flex items-center p-2 space-x-3 rounded-md">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-400">
				...
				<li className="rounded-sm dark:bg-gray-800 dark:text-gray-50">
					<Link rel="noopener noreferrer" to="/fas" className="flex items-center p-2 space-x-3 rounded-md">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-400">
